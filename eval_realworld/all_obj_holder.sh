...
# output_name="${task_name}_all_360_30_bs2048" 
...
cp a_holder_T/T_o_hand_pose.npy ${output_name}

# 第六步：正式运行(运行前先开位姿检测)
# python deploy_silky_auto.py  -c results/coordiff_real/coordiff_mlp_rms_leaf/cwn_holder_d
